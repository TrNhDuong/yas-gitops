...
OLD_GITOPS="${1:-https://github.com/Duong-Dung/yas-gitops.git}"
NEW_GITOPS="${2:-}"
...
if [[ -z "$NEW_GITOPS" && -z "$NEW_REV" ]]; then
  ...
  echo "Example: $0 https://github.com/Duong-Dung/yas-gitops.git https://github.com/Duong-Dung/my-yas-gitops.git fix/k8s-minikube-yas-deploy develop" >&2
  exit 1
fi
